 ...
 * Primer slide de la página de inicio
 */
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center relative">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div 
          className={`absolute inset-0 bg-gradient-to-br from-gray-900 via-purple-900 to-black transition-opacity duration-1000 ${
