  ...
  return (
    <div className="h-screen w-full flex items-center justify-center relative">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div 
          className={`absolute inset-0 bg-gradient-to-br from-green-900 via-blue-900 to-black transition-opacity duration-1000 ${
        ...
        {shouldLoadVideo && (
          <video
            ref={videoRef}
            src="/media/Identidad/Seo_disruptivo_lab.mp4"
